...
function DriverDetail() {
  ...
  useEffect(() => {
    dispatch(MasterDetailInfo(params.id));
  }, [Driver?.data?.data[0].id]);

  return (
    <Box>
      {Driver.loading ? <LinearProgress /> : null}
      <SearchBar
      ...
      <AppBar className={classes.panel} position="relative">
        ...
        >
          ...
          />
          <Tab
            style={{ backgroundColor: value === "6" ? "#1e1a46" : "" }}
            value="6"
      ...
      <TabPanel value={value} index="2">
        <Inviteds
          ...
          pcode={Driver?.data?.data[0]?.UserCode}
        />
      </TabPanel>
